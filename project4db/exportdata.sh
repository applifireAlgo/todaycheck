...
echo $PATH
OSNAME=`uname -s`
ART_DATA_PATH=/tmp/applifire/db/LAFWNT36NYJX0R1A8SKAW/70A5025B-4378-4B2D-A669-6D5558727836/art/data
AST_DATA_PATH=/tmp/applifire/db/LAFWNT36NYJX0R1A8SKAW/70A5025B-4378-4B2D-A669-6D5558727836/ast/data
DB_NAME=applifire
USER=root
PASSWORD=Glass4#21
PORT=3306
...
MYSQL=/usr/bin
PROJECT_ID=LAFWNT36NYJX0R1A8SKAW
