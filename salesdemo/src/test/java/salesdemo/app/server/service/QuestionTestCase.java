...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestion("Y3VKewhvZTxTVMvSgcMrZBzXpErfOXM9XDhdWkns7sFw4upAcJ");
            question.setQuestionDetails("nXn");
            question.setQuestionIcon("ope80HM302xsOlwUywIbRCppm9orW5kDFQnpLMeTojGJwAXTJ1");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("vBfM0guGhdR0P9dbLeNhcNXxhiSJ8SW6y5Ercrv8Jpc3kP9wRq");
            question.setQuestionDetails("GKq");
            question.setQuestionIcon("V5L8gucVfp4XMcGVaCE2uKo64a89b0fGobCE6u85mdF8ajm8so");
