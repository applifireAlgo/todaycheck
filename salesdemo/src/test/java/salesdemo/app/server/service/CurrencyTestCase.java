...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("2Qgr5QxwpKCEhH10nQMHeEHb3uVPRqPh");
            country.setCapitalLatitude(3);
            country.setCapitalLongitude(2);
            country.setCountryCode1("T2K");
            country.setCountryCode2("ocy");
            country.setCountryFlag("WbCVZsbmrBMQO4doHrwpXUB3uEP79c9gvzW5cr8mqstt8fUNOb");
            country.setCountryName("0pif6je86sXegYU9DKxmETHfcLYkEoILyYYL54W87LDRHFsE1b");
            country.setCurrencyCode("HiX");
            country.setCurrencyName("epthnnuq7pAr78SvZyY5U8xo05mpUkcVujewwVkcnX4kh4Sx6n");
            country.setCurrencySymbol("9iuwRdDSixvO8cXEVPIDRFvo5gL3pkT1");
            country.setIsoNumeric(6);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("5kEG1SDRNJnNbtmXgqF0iptb7OX3vuuj8FDY1H57b4arSpuLzt");
            currency.setUnicodeDecimal("vgFjkmcwzCpyURecG0nk0gnNcC2VqXK86OXYZrtVT8HzAMVDy0");
            currency.setUnicodeHex("NMAVrS8aIpEdc8pz9k9h87RJabz1iU0Qk9uDCd3zMV8OpF4TKM");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("o0L6qSZqj15lfUuAhXt2qTvnW6u9FYDZHRkvz3aBh1Wk6sIQ50");
            currency.setUnicodeDecimal("Z0QuEuv66TT0J5DIFgILsH7tdFVmHpZECIuDCP7wCw69MkUSHe");
            currency.setUnicodeHex("FsLHa1W7Ig4YZPTsvYuH6nyugN1YlXor4kxV7u6yZwOt6MMSka");
