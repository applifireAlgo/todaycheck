...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "Question", complexity = Complexity.LOW)
...
public class Question implements Serializable, CommonEntityInterface, Comparator<Question> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.authentication.Question other = (salesdemo.app.shared.authentication.Question) obj;
            if (questionId == null) {
                return false;
