...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "AAA@AAA.AAA", versionNumber = "3", comments = "PassRecovery", complexity = Complexity.LOW)
...
public class PassRecovery implements Serializable, CommonEntityInterface, PassRecoveryInterface, Comparator<PassRecovery> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.authentication.PassRecovery other = (salesdemo.app.shared.authentication.PassRecovery) obj;
            if (passRecoveryId == null) {
                return false;
