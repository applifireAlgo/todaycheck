...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "UserAccessDomain", complexity = Complexity.LOW)
...
public class UserAccessDomain implements Serializable, CommonEntityInterface, Comparator<UserAccessDomain> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.authentication.UserAccessDomain other = (salesdemo.app.shared.authentication.UserAccessDomain) obj;
            if (userAccessDomainId == null) {
                return false;
