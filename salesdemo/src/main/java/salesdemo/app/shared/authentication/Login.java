...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "Login", complexity = Complexity.LOW)
...
public class Login implements Serializable, CommonEntityInterface, UserAuthentication, Comparator<Login> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.authentication.Login other = (salesdemo.app.shared.authentication.Login) obj;
            if (loginPk == null) {
                return false;
