...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "UserAccessLevel", complexity = Complexity.LOW)
...
public class UserAccessLevel implements Serializable, CommonEntityInterface, Comparator<UserAccessLevel> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.authentication.UserAccessLevel other = (salesdemo.app.shared.authentication.UserAccessLevel) obj;
            if (userAccessLevelId == null) {
                return false;
