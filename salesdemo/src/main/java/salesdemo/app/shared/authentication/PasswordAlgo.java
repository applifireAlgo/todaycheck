...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "PasswordAlgo", complexity = Complexity.LOW)
...
public class PasswordAlgo implements Serializable, CommonEntityInterface, PasswordAlgoInterface, Comparator<PasswordAlgo> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.authentication.PasswordAlgo other = (salesdemo.app.shared.authentication.PasswordAlgo) obj;
            if (algoId == null) {
                return false;
