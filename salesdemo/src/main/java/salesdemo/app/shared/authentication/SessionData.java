...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "SessionData", complexity = Complexity.LOW)
...
public class SessionData implements Serializable, CommonEntityInterface, SessionDataInterface, Comparator<SessionData> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.authentication.SessionData other = (salesdemo.app.shared.authentication.SessionData) obj;
            if (dataId == null) {
                return false;
