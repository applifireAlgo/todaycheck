...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "AAA@AAA.AAA", versionNumber = "2", comments = "UserData", complexity = Complexity.LOW)
...
public class UserData implements Serializable, CommonEntityInterface, UserDataInterface, Comparator<UserData> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.authentication.UserData other = (salesdemo.app.shared.authentication.UserData) obj;
            if (userDataId == null) {
                return false;
