...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "Language", complexity = Complexity.LOW)
...
public class Language implements Serializable, CommonEntityInterface, Comparator<Language> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.location.Language other = (salesdemo.app.shared.location.Language) obj;
            if (languageId == null) {
                return false;
