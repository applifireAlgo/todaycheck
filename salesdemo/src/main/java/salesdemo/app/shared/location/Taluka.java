...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "Taluka", complexity = Complexity.LOW)
...
public class Taluka implements Serializable, CommonEntityInterface, Comparator<Taluka> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.location.Taluka other = (salesdemo.app.shared.location.Taluka) obj;
            if (talukaId == null) {
                return false;
