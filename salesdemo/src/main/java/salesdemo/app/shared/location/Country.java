...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "Country", complexity = Complexity.LOW)
...
public class Country implements Serializable, CommonEntityInterface, Comparator<Country> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.location.Country other = (salesdemo.app.shared.location.Country) obj;
            if (countryId == null) {
                return false;
