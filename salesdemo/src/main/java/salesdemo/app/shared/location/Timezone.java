...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "Timezone", complexity = Complexity.LOW)
...
public class Timezone implements Serializable, CommonEntityInterface, TimeZoneInterface, Comparator<Timezone> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.location.Timezone other = (salesdemo.app.shared.location.Timezone) obj;
            if (timeZoneId == null) {
                return false;
