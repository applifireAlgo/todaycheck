...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "Currency", complexity = Complexity.LOW)
...
public class Currency implements Serializable, CommonEntityInterface, Comparator<Currency> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.location.Currency other = (salesdemo.app.shared.location.Currency) obj;
            if (currencyId == null) {
                return false;
