...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "District", complexity = Complexity.LOW)
...
public class District implements Serializable, CommonEntityInterface, Comparator<District> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.location.District other = (salesdemo.app.shared.location.District) obj;
            if (districtId == null) {
                return false;
