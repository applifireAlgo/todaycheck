...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "Address", complexity = Complexity.LOW)
...
public class Address implements Serializable, CommonEntityInterface, Comparator<Address> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.location.Address other = (salesdemo.app.shared.location.Address) obj;
            if (addressId == null) {
                return false;
