package salesdemo.app.shared.location;
...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "AddressExtended", complexity = Complexity.LOW)
...
public class AddressExtended implements Serializable, CommonEntityInterface, Comparator<AddressExtended> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.location.AddressExtended other = (salesdemo.app.shared.location.AddressExtended) obj;
            if (addExtId == null) {
                return false;
