...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "Region", complexity = Complexity.LOW)
...
public class Region implements Serializable, CommonEntityInterface, Comparator<Region> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.location.Region other = (salesdemo.app.shared.location.Region) obj;
            if (regionId == null) {
                return false;
