...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "CommunicationGroup", complexity = Complexity.LOW)
...
public class CommunicationGroup implements Serializable, CommonEntityInterface, Comparator<CommunicationGroup> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.contacts.CommunicationGroup other = (salesdemo.app.shared.contacts.CommunicationGroup) obj;
            if (commGroupId == null) {
                return false;
