...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "ContactType", complexity = Complexity.LOW)
...
public class ContactType implements Serializable, CommonEntityInterface, Comparator<ContactType> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.contacts.ContactType other = (salesdemo.app.shared.contacts.ContactType) obj;
            if (contactTypeId == null) {
                return false;
