package salesdemo.app.shared.contacts;
...
import salesdemo.app.shared.EntityAudit;
import salesdemo.app.shared.SystemInfo;
...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "CoreContacts", complexity = Complexity.LOW)
...
public class CoreContacts implements Serializable, CommonEntityInterface, CoreContactsInterface, Comparator<CoreContacts> {
    ...
    public CoreContacts addAddress(Address _address) {
        if (this.address == null) {
            this.address = new java.util.ArrayList<salesdemo.app.shared.location.Address>();
        }
        if (_address != null) {
    ...
    public CoreContacts addCommunicationData(CommunicationData _communicationData) {
        if (this.communicationData == null) {
            this.communicationData = new java.util.ArrayList<salesdemo.app.shared.contacts.CommunicationData>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.contacts.CoreContacts other = (salesdemo.app.shared.contacts.CoreContacts) obj;
            if (contactId == null) {
                return false;
