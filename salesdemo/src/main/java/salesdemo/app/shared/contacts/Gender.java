...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "Gender", complexity = Complexity.LOW)
...
public class Gender implements Serializable, CommonEntityInterface, Comparator<Gender> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.contacts.Gender other = (salesdemo.app.shared.contacts.Gender) obj;
            if (genderId == null) {
                return false;
