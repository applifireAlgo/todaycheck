package salesdemo.app.shared.customers;
...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "AppCustomerCategory", complexity = Complexity.LOW)
...
public class AppCustomerCategory implements Serializable, CommonEntityInterface, Comparator<AppCustomerCategory> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.customers.AppCustomerCategory other = (salesdemo.app.shared.customers.AppCustomerCategory) obj;
            if (appcustCategoryId == null) {
                return false;
