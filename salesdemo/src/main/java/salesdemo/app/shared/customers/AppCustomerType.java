...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "AppCustomerType", complexity = Complexity.LOW)
...
public class AppCustomerType implements Serializable, CommonEntityInterface, Comparator<AppCustomerType> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.customers.AppCustomerType other = (salesdemo.app.shared.customers.AppCustomerType) obj;
            if (appcustTypeId == null) {
                return false;
