...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "AAA@AAA.AAA", versionNumber = "3", comments = "RoleMenuBridge", complexity = Complexity.LOW)
...
public class RoleMenuBridge implements Serializable, CommonEntityInterface, Comparator<RoleMenuBridge> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.authorization.RoleMenuBridge other = (salesdemo.app.shared.authorization.RoleMenuBridge) obj;
            if (roleMenuMapId == null) {
                return false;
