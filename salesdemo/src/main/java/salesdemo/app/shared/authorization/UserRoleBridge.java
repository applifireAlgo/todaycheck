...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "UserRoleBridge", complexity = Complexity.LOW)
...
public class UserRoleBridge implements Serializable, CommonEntityInterface, Comparator<UserRoleBridge> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.authorization.UserRoleBridge other = (salesdemo.app.shared.authorization.UserRoleBridge) obj;
            if (roleUserMapId == null) {
                return false;
