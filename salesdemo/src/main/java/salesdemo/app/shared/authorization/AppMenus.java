...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "AppMenus", complexity = Complexity.LOW)
...
public class AppMenus implements Serializable, CommonEntityInterface, Comparator<AppMenus> {
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.authorization.AppMenus other = (salesdemo.app.shared.authorization.AppMenus) obj;
            if (menuId == null) {
                return false;
