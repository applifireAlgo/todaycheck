package salesdemo.app.shared.authorization;
...
@SourceCodeAuthorClass(createdBy = "AAA@AAA.AAA", updatedBy = "", versionNumber = "1", comments = "Roles", complexity = Complexity.LOW)
...
public class Roles implements Serializable, CommonEntityInterface, Comparator<Roles> {
    ...
    public Roles addRoleMenuBridge(RoleMenuBridge _roleMenuBridge) {
        if (this.roleMenuBridge == null) {
            this.roleMenuBridge = new java.util.ArrayList<salesdemo.app.shared.authorization.RoleMenuBridge>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            salesdemo.app.shared.authorization.Roles other = (salesdemo.app.shared.authorization.Roles) obj;
            if (roleId == null) {
                return false;
