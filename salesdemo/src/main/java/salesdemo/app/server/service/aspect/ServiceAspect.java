package salesdemo.app.server.service.aspect;
...
public class ServiceAspect {
    ...
    @Pointcut("execution(* salesdemo.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* salesdemo.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* salesdemo.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* salesdemo.app.server.service..*..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* salesdemo.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* salesdemo.app.server.service..get*(..))")
