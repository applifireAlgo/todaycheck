Ext
		.define(
				'Salesdemo.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Salesdemo.view.searchengine.search.SearchEngineMainPanelController','Salesdemo.view.searchengine.search.PanelHeaderField' ,'Salesdemo.view.searchengine.search.ReportGridView','Salesdemo.view.searchengine.search.ReportChartView','Salesdemo.view.searchengine.search.documentView','Salesdemo.view.searchengine.search.DouMeanView','Salesdemo.view.googlemaps.map.MapPanel'],
