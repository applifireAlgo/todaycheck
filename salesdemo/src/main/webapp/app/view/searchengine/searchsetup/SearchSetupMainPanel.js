 ...
 * 
 */
Ext.define('Salesdemo.view.searchengine.searchsetup.SearchSetupMainPanel', 
{
	extend : 'Ext.panel.Panel',
	xtype : 'searchsetup',
	requires : [ 'Ext.layout.container.HBox', 'Ext.layout.container.VBox', 'Salesdemo.view.searchengine.searchsetup.SearchSetupMainPanelController',
	             'Salesdemo.view.searchengine.searchsetup.ChartFieldsModel',
	           ],
