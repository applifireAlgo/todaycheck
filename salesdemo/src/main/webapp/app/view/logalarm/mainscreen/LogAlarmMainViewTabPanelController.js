 ...
 * 
 */
Ext.define('Salesdemo.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	{
		debugger;
		var component = Ext.create("Salesdemo.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
