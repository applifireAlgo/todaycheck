 ...
 * 
 */
Ext.define('Salesdemo.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Salesdemo.view.logalarm.mainscreen.AddLogAlarmController',
			'Salesdemo.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Salesdemo.view.logalarm.mainscreen.AppAlarmPanel',
