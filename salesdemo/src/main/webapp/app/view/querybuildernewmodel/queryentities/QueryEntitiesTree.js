Ext.define('Salesdemo.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Salesdemo.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
