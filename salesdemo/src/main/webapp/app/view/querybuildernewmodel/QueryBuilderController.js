Ext.define('Salesdemo.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Salesdemo.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Salesdemo.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Salesdemo.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Salesdemo.view.querybuildernewmodel.querydetail.QueryDetail');
