Ext.define('Salesdemo.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Salesdemo.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Salesdemo.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Salesdemo.view.querybuildernewmodel.floatingentity.EntitySprite',
