Ext.define('Salesdemo.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Salesdemo.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
