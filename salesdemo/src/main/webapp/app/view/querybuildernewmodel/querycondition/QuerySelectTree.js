Ext.define('Salesdemo.view.querybuildernewmodel.querycondition.QuerySelectTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Salesdemo.view.querybuildernewmodel.querycondition.QuerySelectController',
