 ...
 * 
 */
Ext.define('Salesdemo.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Salesdemo.view.securityconfig.SecurityConfigController',
			'Salesdemo.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
