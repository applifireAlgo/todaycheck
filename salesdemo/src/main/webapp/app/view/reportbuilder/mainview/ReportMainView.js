Ext.define('Salesdemo.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Salesdemo.view.reportbuilder.reportlist.ReportListPanelView',
             'Salesdemo.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Salesdemo.view.reportbuilder.mainview.ReportMainController'
             ],
