Ext.define('Salesdemo.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Salesdemo.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Salesdemo.view.reportbuilder.gridconfig.GridConfigView',
	           'Salesdemo.view.reportbuilder.properties.PropertiesPanelView',
	           'Salesdemo.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
