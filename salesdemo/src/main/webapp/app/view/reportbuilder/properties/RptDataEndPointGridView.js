Ext.define('Salesdemo.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Salesdemo.view.reportbuilder.properties.RptDataEndPointGridController'],
