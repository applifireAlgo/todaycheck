...
Ext
		.define(
				'Salesdemo.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Salesdemo.view.logger.tabs.details.DetailsTab',
							'Salesdemo.view.logger.tabs.fileconnector.FileConnectorTab',
							'Salesdemo.view.logger.tabs.dbconnector.DBConnectorTab',
							'Salesdemo.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Salesdemo.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Salesdemo.view.logger.LogConfigurationTabPanelController',
