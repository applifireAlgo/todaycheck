 ...
 * 
 */
Ext.define('Salesdemo.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Salesdemo.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
