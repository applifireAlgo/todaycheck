 ...
 * 
 */
Ext.define("Salesdemo.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Salesdemo.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
