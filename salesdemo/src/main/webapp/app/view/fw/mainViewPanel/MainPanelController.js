Ext.define('Salesdemo.view.fw.mainViewPanel.MainPanelController', {
	extend : 'Ext.app.ViewController',
	requires : ['Ext.util.Cookies',
	            'Salesdemo.view.login.ChangePasswordScreen'],
	...
	afterRender:function()
	{
		...
		if(cookieChangePwd=="true"){
			 var component = Ext.create("Salesdemo.view.login.ChangePasswordScreen",
							{
								modal:true,
							});
			 component.show();
