Ext.define('Salesdemo.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Salesdemo.view.reportui.datachart.chart.RatingField','Salesdemo.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
