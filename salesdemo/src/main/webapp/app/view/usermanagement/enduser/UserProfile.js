Ext.define('Salesdemo.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Salesdemo.view.usermanagement.enduser.UserProfileController', 'Salesdemo.view.usermanagement.admin.AddUserDetailsViewModel', 'Salesdemo.model.AddUserDataModel' ],
