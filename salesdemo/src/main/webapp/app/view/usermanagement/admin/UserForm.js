Ext.define('Salesdemo.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Salesdemo.view.usermanagement.admin.AddUserDetailsViewModel', 'Salesdemo.model.AddUserDataModel' ],
