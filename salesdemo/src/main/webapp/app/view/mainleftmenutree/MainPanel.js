Ext.define('Salesdemo.view.mainleftmenutree.MainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'mainPanelWithLeftMenu',

	requires : [ 'Salesdemo.view.resource.ResourcePanel',
			'Salesdemo.view.mainleftmenutree.TopPanel.TopPanel',
			'Ext.layout.container.Accordion', 'Ext.Img', 'Ext.button.Split',
			'Salesdemo.view.resource.DockedResourcePanel','Salesdemo.view.fw.mainViewPanel.MainPanelController' ],
