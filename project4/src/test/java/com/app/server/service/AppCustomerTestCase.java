...
public class AppCustomerTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomercategory.setCustomerCategory("HaH35ft2gwHCtEfWADlZwzecIryC7todNpeUMR8mgQvw1DypXb");
            ...
            appcustomertype.setCustomerType("ZTkBJYuC9R8wVBlIC2YuwfPOkrGGZO9WgJ6VdM6c4xH35GHzyZ");
            ...
            corecontacts.setEmailId("37TMbaaZj7FAtRfq9N6ajUbcO1WpVjwkEVCI59tUeKDRd5IdY7");
            corecontacts.setFirstName("PIGUOWWdbGVfi4jqg9UN8FpN4u5HP3DZIlrUrLJrGmrIwfuZi1");
            Gender gender = new Gender();
            gender.setGender("EO5QRmeFWgcR49fWZaCF4gUgfrrVYrRGQiJvg8QDhiJazGtDPj");
            Gender GenderTest = genderRepository.save(gender);
            map.put("GenderPrimaryKey", gender._getPrimarykey());
            Language language = new Language();
            language.setAlpha2("YB");
            language.setAlpha3("h35");
            language.setAlpha4("kP24");
            language.setAlpha4parentid(9);
            language.setLanguage("7RJJcnDVLcY9467yk2NgxCikJR0AAT3LTzCE22R5BXySomhzCa");
            language.setLanguageDescription("xLcVc6EAtPT86KmXFbjol569GNXZt4n8J7mUQiQXJna89cATan");
            language.setLanguageIcon("DueRA3tSuLdFRqksZkD82bEze7fgDXnBxiI8EKzy20JFbPO10L");
            language.setLanguageType("jFdJALohv8HufellKYA1BmQcgaXo3xgx");
            Language LanguageTest = languageRepository.save(language);
            map.put("LanguagePrimaryKey", language._getPrimarykey());
            Timezone timezone = new Timezone();
            timezone.setCities("2vAfsTKhwxnwExwodwel9bb16xpUo9Hc4mat7dvLIJJnUYebYK");
            timezone.setCountry("tjU4TFKxZNW2tV0jafwlZdgNnlW1QeVeXYNRrgn6nxPwEg9kuw");
            timezone.setGmtLabel("H81rIFQHBy3V07tQllnxeJsrtXRkjTbcVUi7CGmScV2ew2fxIW");
            timezone.setTimeZoneLabel("tHEqvvfRdxNnOUYZ3UBooAEaiPskBMUkQcxpetILWjzO9zi91I");
            timezone.setUtcdifference(7);
            Title title = new Title();
            title.setTitles("j93WBuqMQqs82EsSkkpWjZ6XUQQlAPwdPUzNyHHmXd7SvwVf3u");
            Title TitleTest = titleRepository.save(title);
            map.put("TitlePrimaryKey", title._getPrimarykey());
            corecontacts.setAge(82);
            corecontacts.setApproximateDOB(new java.sql.Date(123456789));
            corecontacts.setDateofbirth(new java.sql.Date(123456789));
            corecontacts.setEmailId("dRRzu2pnLpAy4gqunL30zL4ytRYJ87bEKatGT7Loy4NLqI1ttZ");
            corecontacts.setFirstName("CZjoGQfbzXfchfUV2kTe4cdqltRWzGRXi6hpV6WDD2Lyx3y9GU");
            corecontacts.setGenderId((java.lang.String) GenderTest._getPrimarykey()); /* ******Adding refrenced table data */
            corecontacts.setLastName("3q9hEDZNFFdg24M8DdJ3PjwxYzKS37MUdJapXX5glPMAjzaVkK");
            corecontacts.setMiddleName("vEctPlglkUTwVm8NuFqTOwv1tNfIqWUpI4nTq963KPDWeXkeUW");
            corecontacts.setNativeFirstName("vUYckFfE4Z9xCFZBRgCV5PSullFCtdGxSOzrWbb9AC9Tl87dzQ");
            corecontacts.setNativeLanguageCode((java.lang.String) LanguageTest._getPrimarykey()); /* ******Adding refrenced table data */
            corecontacts.setNativeLastName("hpr0SU1SjSiGLMzm0RyHODQqpwZItU2gOL9WJvsPUGUyO7Qx0S");
            corecontacts.setNativeMiddleName("QPAys4Ye1UnfmBd7QijxUIC1Z7wYzn3Je6dlHjfYSqXNl0txoN");
            corecontacts.setNativeTitle("YjXr9HtylHn1hqKwOCoakAIrqChkFAFbFZIOyky8ayJF7Ks4WS");
            corecontacts.setPhoneNumber("O06sZe0PnW3uNdPNkTTB");
            ...
            appcustomer.setCustomerName("0U3ZHR3Tsx0f7hP7YWSdvKk9HpTTeBQkX12HP4u9keNLjkKuzx");
    ...
    public void test2Update() {
        try {
            ...
            appcustomer.setCustomerName("8ChIp92vSU1bOIUF9fy2xzYnkZnjAoP9sUFuEaED3aii5CE98t");
