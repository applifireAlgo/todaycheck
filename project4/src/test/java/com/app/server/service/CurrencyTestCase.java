...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("0RErxoVrHNNWKaQcVgKmvcaih0z8H8bu");
            country.setCapitalLatitude(9);
            country.setCapitalLongitude(1);
            country.setCountryCode1("T2F");
            country.setCountryCode2("eQq");
            country.setCountryFlag("qf3XIeA2acb0e3D8m77wEUJcPhAeTdWvL9yvgc5bChyvl79PUZ");
            country.setCountryName("BKdRXMHEJbKS69PkssjXtS5nxOv5pii8zaHvvLafgHUSU7lqlC");
            country.setCurrencyCode("qMk");
            country.setCurrencyName("OxakvYHWy1w1JeL7IXYsQdYzWqtqRWM9piM3WEMXXYXliLqrdk");
            country.setCurrencySymbol("V4SLH3nZXh3pfHA9wirlZffK7TxESmP3");
            country.setIsoNumeric(9);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("HsJs2WuWhsblc2CE26VJ9A1eV3krWAHVUMEgv6FO9oWY4GxvGs");
            currency.setUnicodeDecimal("ouXOhlLhHCDEQBcY5pdHYHj8FwZQKhUEQm0dbibLoJQ19UmnoX");
            currency.setUnicodeHex("ZZuw1AsbchhO0cE1tzrKbHygYB0jjaKDYhrz14kPjXbzJukIIG");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("yYBmjZmzD4RbKbhefzwv8oGVxXB3EjelxfYysg9VbfHwtqQCNX");
            currency.setUnicodeDecimal("5fe8miAxNKypCS746jHzFB7LNOnM2jQEolW2KWdEQndikgu1vc");
            currency.setUnicodeHex("o3fzWFzGVQUMtjmz0joZSL1RRDTSBVX2mKwHtKeCGyL29X6dKT");
