...
folder are mapped to the application's root namespace, 'Project4'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Project4' in the same way
as `"Project4/sass/src"`.
