...
Ext
		.define(
				'Project4.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Project4.view.logger.tabs.details.DetailsTab',
							'Project4.view.logger.tabs.fileconnector.FileConnectorTab',
							'Project4.view.logger.tabs.dbconnector.DBConnectorTab',
							'Project4.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Project4.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Project4.view.logger.LogConfigurationTabPanelController',
