 ...
 * 
 */
Ext.define('Project4.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Project4.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
