Ext.define('Project4.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Project4.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Project4.view.console.ConsoleWindow');
