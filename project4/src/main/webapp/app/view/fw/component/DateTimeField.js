 ...
 */
Ext.define('Project4.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Project4.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Project4.view.fw.component.DateTimePicker(o);
    },
