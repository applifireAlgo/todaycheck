Ext.define('Project4.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Project4.view.searchengine.search.NorthPanel', 'Project4.view.searchengine.search.SearchResult','Project4.view.searchengine.search.SearchEngineMainPanelController'],
