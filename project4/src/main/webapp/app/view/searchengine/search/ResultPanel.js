Ext
		.define(
				'Project4.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Project4.view.searchengine.search.SearchEngineMainPanelController','Project4.view.searchengine.search.PanelHeaderField' ,'Project4.view.searchengine.search.ReportGridView','Project4.view.searchengine.search.ReportChartView','Project4.view.searchengine.search.documentView','Project4.view.searchengine.search.DouMeanView','Project4.view.googlemaps.map.MapPanel'],
