Ext.define('Project4.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Project4.view.reportui.datachart.chart.RatingField','Project4.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
