 ...
 * 
 */
Ext.define('Project4.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Project4.view.securityconfig.SecurityConfigController',
			'Project4.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
