Ext.define('Project4.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Project4.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Project4.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Project4.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Project4.view.querybuildernewmodel.querydetail.QueryDetail');
