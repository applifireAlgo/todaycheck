Ext.define('Project4.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Project4.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
