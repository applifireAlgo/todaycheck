Ext.define('Project4.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Project4.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Project4.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Project4.view.querybuildernewmodel.floatingentity.EntitySprite',
