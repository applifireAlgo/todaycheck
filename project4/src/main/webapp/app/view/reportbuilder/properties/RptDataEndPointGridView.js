Ext.define('Project4.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Project4.view.reportbuilder.properties.RptDataEndPointGridController'],
