Ext.define('Project4.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Project4.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Project4.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Project4.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Project4.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
