Ext.define('Project4.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Project4.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Project4.view.reportbuilder.gridconfig.GridConfigView',
	           'Project4.view.reportbuilder.properties.PropertiesPanelView',
	           'Project4.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
