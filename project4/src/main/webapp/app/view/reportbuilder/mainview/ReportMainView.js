Ext.define('Project4.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Project4.view.reportbuilder.reportlist.ReportListPanelView',
             'Project4.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Project4.view.reportbuilder.mainview.ReportMainController'
             ],
