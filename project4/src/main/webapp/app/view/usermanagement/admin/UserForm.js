Ext.define('Project4.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Project4.view.usermanagement.admin.AddUserDetailsViewModel', 'Project4.model.AddUserDataModel' ],
