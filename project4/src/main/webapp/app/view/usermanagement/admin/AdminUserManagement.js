Ext.define('Project4.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Project4.view.usermanagement.admin.UserPasswordReset',
	            'Project4.view.usermanagement.admin.AddUserDetails',
	            'Project4.view.usermanagement.admin.ViewUser'],
