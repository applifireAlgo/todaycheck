 ...
 * 
 */
Ext.define('Project4.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Project4.view.logalarm.mainscreen.AddLogAlarmController',
			'Project4.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Project4.view.logalarm.mainscreen.AppAlarmPanel',
